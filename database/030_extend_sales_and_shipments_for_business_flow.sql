-- -------------------------------------------------------------------------
-- Extiende ventas/envios para soportar:
-- 1) Tipo de venta (SUCURSAL / INDIVIDUAL).
-- 2) Datos de comprador individual.
-- 3) Flujo de envio pagado por cliente/nosotros.
-- 4) Referencia de grupo para ventas/envios multiproducto.
-- -------------------------------------------------------------------------
begin;
