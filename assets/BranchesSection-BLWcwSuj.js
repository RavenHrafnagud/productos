import{g as ve,a as be,b as Se,c as Ee,d as Ne,r as t,t as N,j as e,S as Te,e as Pe,f as Fe,h as De,i as Ue,k as ke,F as Be,l as Ie,m as l,I as m,n as P,B as se,G as j,o as c,p as V,P as we,D as Me,T as Oe,q as Re,s as Ae,u as ze,v as Le,w as x,x as Ve,y as u,z as $e,A as Ge}from"./index-letmuZTJ.js";function Qe(){return ve()}function qe(n,d=""){return be(n,{query:d})}function He(n,d,v=""){return!n||!d?[]:Ee(n,d,{query:v})}function _e(n){return Se(n)}function We(n,d){return Ne(n,d)}const $={nit:"",rut:"",rutPdfUrl:"",porcentajeComision:0,nombre:"",direccion:"",ciudad:"",localidad:"",pais:"CO",telefono:"",email:"",estado:!0},Ye=x.div`
  display: grid;
